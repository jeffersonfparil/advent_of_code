...
fun_cave_crawler_recursive = function(vec_vec_path, mat_str_nonstarting_caves, vec_caves_list_lowercase; part1=true)
    ...
    if bool_test
        ...
        for j in 1:size(mat_str_connected_caves,2)
            ...
            vec_vec_path = fun_cave_crawler_recursive(vec_vec_path, mat_str_nonstarting_caves, vec_caves_list_lowercase, part1=part1)
        end
...
fun_find_all_paths = function(fname; part1=true)
    ...
    for i in idx_starting_caves
        ...
        X = fun_cave_crawler_recursive(vec_vec_path, mat_str_nonstarting_caves, vec_caves_list_lowercase, part1=part1)[1:(end-1)]
